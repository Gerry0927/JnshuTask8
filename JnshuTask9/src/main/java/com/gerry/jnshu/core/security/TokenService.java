...
import com.gerry.jnshu.core.constant.Constants;
import com.gerry.jnshu.core.redis.RedisCache;
import com.gerry.jnshu.core.utils.IdUtils;
...
public class TokenService {
     ...
     * 设置用户身份信息
     */
    public void setLoginUser(JwtUser loginUser) {
     ...
     * @param loginUser 用户
     */
    public void verifyToken(JwtUser loginUser) {
     ...
     */
    public void refreshToken(JwtUser loginUser) {
     ...
     * @param loginUser 登录信息
     */
//    public void setUserAgent(JwtUser loginUser) {
