package com.gerry.task.core.limit;
...
import static com.gerry.task.core.constant.ServiceExceptionEnum.REQUEST_LIMIT;
...
public class LimitInterceptor {
    ...
    @Around("execution(public * *(..)) && @annotation(com.gerry.task.core.limit.Limit)")
